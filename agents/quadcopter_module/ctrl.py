...
#import utils
from . import config as quadcopter_config_file
...
config_quad_ll_gains = {'quad_low_level_pos_P_gain': list(pos_P_gain),
                        'quad_low_level_vel_P_gain': list(vel_P_gain), 
                        'quad_low_level_vel_D_gain': list(vel_D_gain), 
                        'quad_low_level_vel_I_gain': list(vel_I_gain),
                        'quad_low_level_att_P_gain': list(att_P_gain),
                        'quad_low_level_rate_P_gain': list(rate_P_gain),
                        'quad_low_level_rate_D_gain': list(rate_D_gain),
                        'quad_low_level_velMax': list(velMax),
                        'quad_low_level_rateMax': list(rateMax)}
