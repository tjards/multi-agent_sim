...
def grad_gromacs_soft_core(_gain, states_q, k_node, k_neigh, r_range, d):
...
def grad_morse_gradient(_gain, states_q, k_node, k_neigh, r_range, d):
...
def grad_lennard_jones(_gain, states_q, k_node, k_neigh, r_range, d):
